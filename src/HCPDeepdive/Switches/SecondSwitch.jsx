    ...
    const chartRef = useRef(null);
      ...
      useEffect(() => {
        const data = {
          name: "Evrysdi (n=872)",
          children: [
            { name: "Spinraza", value: "n=7 (0.8%)", color: "#7bb7ed" },
            { name: "Zolgensma", value: "n=40 (4.7%)", color: "#0f90d1" },
            { name: "No Switch", value: "n=805 (94.4%)", color: "#9e9e9e" },
          ],
        };
        ...
        node
          ...
          .attr("height", 30)
          .attr("fill", d => d.data.color || "#e39d34")
          .attr("rx", 5)
          .attr("ry", 5);
