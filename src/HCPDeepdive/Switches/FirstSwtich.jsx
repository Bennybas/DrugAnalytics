...
const FirstSwitch = () => {
  ...
  useEffect(() => {
    const data = {
      name: "Spinraza (n=972)",
      children: [
        { name: "Evrysdi", value: "n=34 (3.5%)", color: "#e39d34" },
        { name: "Zolgensma", value: "n=8 (0.8%)", color: "#0f90d1" },
        { name: "No Switch", value: "n=931 (95.8%)", color: "#9e9e9e" },
      ],
    };
    ...
    node
      ...
      .attr("height", 30)
      .attr("fill", d => d.data.color || "#7bb7ed")
      .attr("rx", 5)
      .attr("ry", 5);
