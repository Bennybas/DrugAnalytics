  ...
  const renderContent = () => {
    switch (activePage) {
      case "Overview":
        return <OverviewPage />
      // case "acc_targeting":
      //   return <div className="p-4">This is the Acc Targeting Independent content.</div>;
      // case "acc_deepdive":
      //   return <div className="p-4">This is the Acc Deepdive content.</div>;
      // case "hcp_homepage":
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <header className="bg-gradient-to-br from-[#9bc0e2]/50 to-[#9bc0e2]/90 text-gray-600 flex items-center justify-between px-6 py-3 border-b border-gray-200 shadow-md">
        ...
        {/* Navigation Cards */}
        <div className="flex flex-row justify-center items-center w-84 gap-2 rounded-3xl bg-white px-2 py-1">
